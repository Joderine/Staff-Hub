    ...
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'var(--bg)', padding: 20 }}>
      <div style={{ width: '100%', maxWidth: 400 }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 40 }}>
          <div style={{ fontFamily: "'Syne', sans-serif", fontWeight: 800, fontSize: 28, letterSpacing: '-0.03em', color: 'var(--accent)', marginBottom: 6 }}>
            Staff Hub
          </div>
...
const inputStyle: React.CSSProperties = {
  ...
  fontSize: 14, padding: '10px 14px', outline: 'none', transition: 'border-color 0.18s',
}
...
const primaryBtn: React.CSSProperties = {
  ...
  borderRadius: 8, padding: '11px 20px', fontFamily: "'DM Sans', sans-serif",
